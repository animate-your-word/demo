  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <div style={{ marginBlock: "1rem" }}>
        We compare our method with three baseline models: two pixel-based models
        (t2v model Gen-2, i2v model DynamiCrafter) and one vector-based
        animation model (LiveSketch). For text-to-video generation, we append
        the prompt with “which looks like a letter §,” where § represents the
